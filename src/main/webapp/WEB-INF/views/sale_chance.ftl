...
<div id="tb">
    <a href="javascript:openAddChanceDialog()" class="easyui-linkbutton" iconCLs="icon-add" plain=true>添加</a>
    <a href="javascript:openModifyChanceDialog()" class="easyui-linkbutton" iconCLs="icon-edit" plain=true>修改</a>
    <a href="javascript:deleteChance()" class="easyui-linkbutton" iconCLs="icon-remove" plain=true>删除</a>
    <br/>
...
<div id='dlg' class="easyui-dialog"  style="width: 500px;height: 400px" title="添加营销机会记录" closed=true buttons="#bt">
    <form  id="fm" method="post">
        客户名称:<input id="cc"  class="easyui-combobox" name="customerName"
                    valueField='name' editable="false"  textField='name' url='${ctx}/customer/queryAllCustomers' panelHeight="auto" />  <br/><br/>
...
<div id="bt">
    <a href="javascript:saveChance()" class="easyui-linkbutton" iconCls="icon-save">保存</a>
